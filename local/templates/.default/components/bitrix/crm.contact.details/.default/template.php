...
\CJSCore::Init(
    [
        ...
        'studiobit_loader',
        'studiobit_matrix_object_search',
        'sidepanel'
    ]
);
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		'SERVICE_URL' => $this->GetFolder().'/ajax.php?action=convert&'.bitrix_sessid_get(),
		'EDITOR' => array(
			'GUID' => "{$guid}_editor",
        ...
        'PROGRESS_BAR_HTML' => $arResult['PROGRESS_BAR_HTML']
	)
);?>