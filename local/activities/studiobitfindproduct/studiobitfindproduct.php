	...
	extends CBPActivity
{
	...
	public function Execute()
	{
        ...
        if((int)$this->deal){
            $result = \CCrmDeal::LoadProductRows((int)$this->deal);

            foreach($result as $ar){
                if($intProduct == 0) {
                    $intProduct = $ar["PRODUCT_ID"];
                }

                $arProducts[] = $ar["PRODUCT_ID"];
            }

			$this->FindProductId = $intProduct;
			$this->FindProductList = $arProducts;
        }
