...
class CBPStudiobitValueArrayElement
	extends CBPActivity
{
	...
	public function Execute()
	{
		...
		#AddMessage2Log($this->Property, "CBPStudiobitValueArrayElement");
		#AddMessage2Log("VALUE: " . json_encode($result), "CBPStudiobitValueArrayElement");
		$rootActivity->SetVariable("VALUE_ARRAY", serialize($result));
